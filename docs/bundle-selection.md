...
- **SysAdminDoc/hushfeed** — the largest catalog by far (80 patches, incl. a dedicated
  ...
  before this report). Promising, but the repo is only 11 days old with zero
...
**Chosen: [hoo-dles/morphe-patches](https://github.com/hoo-dles/morphe-patches)** (sole candidate; functional fit with a real caveat)
...
This is close against SouBryan. browzomje
...
- **Paresh-Maheshwari/paresh-patches (GitLab)** — eliminated outright, same reason as
  under Proton VPN: self-declared archived/dead as of 2026-09-01. (Paresh's own GitLab issue #77 was the source that first confirmed "Telegram" in that
